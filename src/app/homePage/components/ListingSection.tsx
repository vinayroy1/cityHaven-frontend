...
type Listing = { title: string; location: string; price: string; badge?: string; image: string };

type Props = { title: string; listings: Listing[]; cta?: string };

export function ListingSection({ title, listings, cta }: Props) {
  return (
