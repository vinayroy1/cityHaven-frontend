...
export function HeroSearch() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    router.push(`/propertySearch?q=${encodeURIComponent(query)}&category=${encodeURIComponent(activeTab)}`);
  };
      ...
      <div className="relative overflow-hidden rounded-[28px] border border-white/60 bg-white/90 shadow-[0_30px_90px_-40px_rgba(15,23,42,0.6)] backdrop-blur">
        ...
        <div className="relative z-10 px-4 py-5 md:px-6">
          <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              {[
                ...
                <button
                  ...
                  className={`flex items-center gap-2 rounded-full px-3 py-2 transition ${
                    activeTab === tab.label ? "bg-slate-900 text-white shadow-md shadow-slate-900/20" : "hover:bg-slate-100"
                  }`}
                  type="button"
            ...
            <div className="grid gap-3 md:grid-cols-[2fr_1fr_1fr_1fr_auto] md:items-center">
