...
import { Stepper, type StepDescriptor } from "@/components/propertyListing/Stepper";
...
const propertyTypeCatalog: PropertyTypeOption[] = [
  {
    id: "residential",
    label: "Residential",
    resCom: "RESIDENTIAL",
...
const localityOptions: Record<string, { id: string; name: string }[]> = {
  "1": [
...
const furnishingItems = ["Wardrobe", "Geyser", "Modular Kitchen", "Air Conditioning", "Fans & Lights"];

const stepList: StepDescriptor[] = [
...
const stepValidations: Record<number, (keyof PropertyListingFormValues | string)[]> = {
